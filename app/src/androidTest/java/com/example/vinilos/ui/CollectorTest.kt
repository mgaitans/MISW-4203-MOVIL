...
class CollectorTest {
    ...
    fun collectorListTest() {
        ...
        val recyclerView = onView(
            allOf(
                withId(R.id.fragments_collector),
                childAtPosition(
        ...
        val textView1 = onView(
            allOf(
                withId(R.id.textNameCollector), withText("Manolo Bellon"),
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.textTelCollector), withText("3502457896"),
                withParent(withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText("3502457896")))

        val textView3 = onView(
            allOf(
                withId(R.id.textEmailCollector), withText("manollo@caracol.com.co"),
